...
def index(request):
    url = (f"https://newsapi.org/v2/everything?q=gaming, gaming-news, video-games, xbox, nintendo, playstation, video-game-news&language=en&sortBy=publishedAt&apiKey={API}")
